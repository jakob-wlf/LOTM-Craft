    ...
    public DeathPathway(String displayName, String name, String colorPrefix, Color color) {
        ...
        abilities = new HashMap<>(Map.of(
                ...
                4, new Ability[] {
                        ...
                        new UndeadSummoning(this, 4, AbilityType.SEQUENCE_PROGRESSION, "Undead Summoning", Material.BONE_MEAL, "Summon powerful undead from the underworld to serve you.", "undead_summoning")
                },
                3, new Ability[] {
