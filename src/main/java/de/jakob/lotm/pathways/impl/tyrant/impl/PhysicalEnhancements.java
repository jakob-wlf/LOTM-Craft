    ...
    public PhysicalEnhancements(Pathway pathway, int sequence, AbilityType abilityType, String name, Material material, String description, String id) {
        ...
        effectsPerSequence = new HashMap<>(Map.of(
                ...
                7, new PotionEffect[]{
                        ...
                        new PotionEffect(PotionEffectType.DOLPHINS_GRACE, 0, 1),
                        new PotionEffect(PotionEffectType.CONDUIT_POWER, 0, 1),
                        new PotionEffect(PotionEffectType.NIGHT_VISION, 0, 1)
                ...
                5, new PotionEffect[]{
                        ...
                        new PotionEffect(PotionEffectType.REGENERATION, 0, 1),
                        new PotionEffect(PotionEffectType.DOLPHINS_GRACE, 0, 2),
                        new PotionEffect(PotionEffectType.CONDUIT_POWER, 0, 2),
                        new PotionEffect(PotionEffectType.NIGHT_VISION, 0, 1)
                ...
                4, new PotionEffect[]{
                        ...
                        new PotionEffect(PotionEffectType.DOLPHINS_GRACE, 0, 3),
                        new PotionEffect(PotionEffectType.CONDUIT_POWER, 0, 3),
                        new PotionEffect(PotionEffectType.NIGHT_VISION, 0, 1)
                ...
                2, new PotionEffect[]{
                        ...
                        new PotionEffect(PotionEffectType.REGENERATION, 0, 4),
                        new PotionEffect(PotionEffectType.DOLPHINS_GRACE, 0, 4),
                        new PotionEffect(PotionEffectType.CONDUIT_POWER, 0, 4),
                        new PotionEffect(PotionEffectType.NIGHT_VISION, 0, 1)
                ...
                1, new PotionEffect[]{
                        new PotionEffect(PotionEffectType.STRENGTH, 0, 3),
                        new PotionEffect(PotionEffectType.RESISTANCE, 0, 3),
                        new PotionEffect(PotionEffectType.SPEED, 0, 4),
                        new PotionEffect(PotionEffectType.SATURATION, 0, 5),
