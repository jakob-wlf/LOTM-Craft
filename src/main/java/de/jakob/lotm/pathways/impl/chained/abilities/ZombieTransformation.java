...
public class ZombieTransformation extends ToggleableAbility {

    private final Particle.DustOptions greenDust = new Particle.DustOptions(org.bukkit.Color.fromRGB(79,123,57), 1.5f);
    private final Particle.DustOptions grayDust = new Particle.DustOptions(org.bukkit.Color.fromRGB(15, 15, 15), 1.5f);

    public ZombieTransformation(Pathway pathway, int sequence, AbilityType abilityType, String name, Material material, String description, String id) {
    ...
    protected void impl(Beyonder beyonder) {
        ...
        ParticleSpawner.displayParticles(Particle.DUST, entity.getEyeLocation().subtract(0, (entity.getHeight() * 1.15) / 2, 0), 12, .25, (entity.getHeight() / 1.25) / 2, .25, 0, grayDust, 180);
        ParticleSpawner.displayParticles(Particle.DUST, entity.getEyeLocation().subtract(0, (entity.getHeight() * 1.15) / 2, 0), 12, .25, (entity.getHeight() / 1.25) / 2, .25, 0, greenDust, 180);
