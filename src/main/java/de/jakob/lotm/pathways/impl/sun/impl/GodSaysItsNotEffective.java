...
@NoArgsConstructor
public class GodSaysItsNotEffective extends Ability {
    ...
    public GodSaysItsNotEffective(Pathway pathway, int sequence, AbilityType abilityType, String name, Material material, String description, String id) {
        super(pathway, sequence, abilityType, name, material, description, id);

        customModelData = "notar_debuff";
    }
    ...
    public void useAbility(Beyonder beyonder) {
        ...
        runTaskWithDuration(2, 20 * 4, () -> {
            ...
            for(LivingEntity e : affected) {
                e.addPotionEffect(new PotionEffect(PotionEffectType.WEAKNESS, 10, 2, false, false, false));
                e.addPotionEffect(new PotionEffect(PotionEffectType.SLOWNESS, 10, 3, false, false, false));

                Beyonder b = LOTM.getInstance().getBeyonder(e.getUniqueId());
                if(b != null) {
                    b.addMultiplierModifier(.8, 1);
                }
            }
